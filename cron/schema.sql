...
CREATE SEQUENCE IF NOT EXISTS "public"."item_price_history_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "public"."item_price_history_id_seq" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."item_price_history"
    ADD CONSTRAINT "unique_item_timestamp" UNIQUE ("item_id", "timestamp");
...
GRANT ALL ON SEQUENCE "public"."item_price_history_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."item_price_history_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."item_price_history_id_seq" TO "service_role";
